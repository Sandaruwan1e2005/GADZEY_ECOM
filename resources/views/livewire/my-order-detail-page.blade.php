<div class="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto">
  ...
  <div class="flex flex-col md:flex-row gap-4 mt-4">
    ...
    <div class="md:w-1/4">
      <div class="bg-gradient-to-br from-white via-slate-50 to-slate-100 rounded-2xl shadow-lg p-8 border border-slate-200">
        <h2 class="text-xl font-bold mb-6 text-slate-700 tracking-tight">Order Summary</h2>
        ...
        <div class="flex justify-between items-center mb-2">
          <span class="font-semibold text-slate-700">Grand Total</span>
          <span class="font-bold text-lg text-green-600">{{ Number::currency($item->order->grand_total, 'LKR') }}</span>
        </div>
      </div>
    </div>
  </div>
