...
use App\Filament\Columns\MoneyColumn;
use Filament\Tables\Filters\SelectFilter;
use Filament\Tables\Table;
use Illuminate\Support\Str;
use App\Services\AIProductGenerator;
                            ...
                            ->suffixAction(
                                Action::make('generateDescription')
                                    ...
                                    ->action(function (array $data, Set $set) {
                                        ...
                                        $description = \App\Services\AIProductGenerator::generate($productName);
                                        $set('description', $description);
                                    })
                                    ->visible(fn ($state, $get) => !empty($get('name')))
                            ),
    ...
    public static function table(Table $table): Table {
        return $table
            ->columns([
                ...
                MoneyColumn::make('price')->sortable(),
